const data = [
  ...
  {
    id: "2",
    name: "Beautiful Login form",
    about: [
      "Beautiful Login form with dark and light mode built with react-hook-form library.",
    ],
    banner: [
      "dataAssets/projects/login-form/1.jpg",
      "dataAssets/projects/login-form/1.jpg",
    ],
    tech: ["ReactJS", "Redux", "react-hook-form", "Tailwind", "Dark mode"],
    links: ["https://login-form-eta.vercel.app/"],
  },
  {
    id: "3",
    name: "BMI Calculator App",
    about: [
      "This is a modular BMI Calculator built with Webpack, Tailwindcss and more. ( Mobile first) ",
    ],
    banner: [
      "dataAssets/projects/bmi-calculator/1.jpg",
      "dataAssets/projects/bmi-calculator/1.jpg",
    ],
    tech: ["Webpack", "LocalStorage", "Class-based", "Modular", "Eslint"],
    links: ["https://bmi-calculator-omega-five.vercel.app/"],
  },
  {
    id: "4",
...
//     "My clone recommends movies in different genres like Comedy, Horror, Action, and even Netflix Originals 👀. Wait for a second. That is not all. you can watch trailers of movies by clicking on the poster and play button 🤩. Just make sure you have a stable/VPN connection.",
//     "I used Redux Core, a powerful state manager, and Firebase for authentication by Email Address. Movies of the clone, are provided by the great TMDB API. Fetching the Youtube Trailer, managing tons of genres and movies from API were some of the huge challenges that I experienced 👨‍💻.",
//   ],
//   banner: [
//     "dataAssets/projects/netflix/lg/netflix-lq.jpg",
...
//     "Other brands page, has the list of all brands and available phones with filters on the top (price low, price high, name of the brand, etc). Also, you can see a sample detail of one phone.",
//     "Mobile Tech is built with Javascript Vanilla 🤯. It was genuinely challenging for me as my first project.I used pure CSS and SASS to style this beautiful website. I made a Local JSON myself to access the data of phones.",
//   ],
//   banner: [
//     "dataAssets/projects/mobile-tech/lg/mobile-tech-lq.jpg",
